...
{
	header("location:AdminRegisterPage");
}
?>
<html>
    <head>
        ...
        <title>ADMIN LOGIN PAGE - Pharmanalitik</title>
                    ...
                    <div class="panel-heading">
                        <div class="view-header">
                            ...
                            <div class="header-title">
                                <h3>ADMIN LOGIN - Pharmanalitik</h3>
                                <small><strong>Please enter your ADMIN info to login pharmanalitik.</strong></small>
                            </div>
                        </div>
                    </div>
  ...
  if($.trim(username).length > 0 && $.trim(password).length > 0)
  {
   $.ajax({
    ...
    success:function(data)
    {
     ...
     {
      $('#login').val("Login");
      $('#error').html("<span class='text-danger'>Invalid Admin Information!</span>");
     }
    }
   });
  }
