...
<li class="active"> <a href="kar"><img src="img/get-money.png" style="width:20px;height:20px;">  Kar</a>
</li>
...
<li>Charts</li>
<li>Kar</li>
<li class=active>Kar Ana Sayfa</li>
</ol>
</div>
...
<div class=panel-title>
<h5><?php
echo("Kar Drilldown Kategori Dağılım Payı");
?></h5>
</div>
</div>
<div class=panel-body>
 ...
 "type"    : "serial",
  ...
  "legend": {
	...
	"graphs": [
		...
		{
			"balloonText": "Gecen Sene Kar :[[value]]",
			"fillAlphas": 0.8,
			"id": "AmGraph-2",
			"lineAlpha": 0.2,
			"title": "Geçen Sene Kar",
			"type": "column",
			"valueField": "KarLastYear"
		},{
			"balloonText": "Kar:[[value]]",
			"fillAlphas": 0.8,
			"id": "AmGraph-1",
			"lineAlpha": 0.2,
			"title": "Kar",
