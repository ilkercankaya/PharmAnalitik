...
<li class="active"> <a href=""><img src="img/storage-iconONE.jpg" style="width:20px;height:20px;">  Stok<span class="fa arrow"></span></a>
<ul class="nav nav-second-level">
<li> <a href="stok">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Stok Ana sayfa</a>
<li class="active"> <a href="stokAnalitik">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Stok Analiz</a>
</ul>
</li>
...
<h1> <?php print $data["Eczane_Adi"]; ?> Eczanesi Stok Analiz Göstergeleri.</small></h1>
 <small><?php print $data["Eczane_Adi"]; ?> eczanesi ile stok bilgileri.</small>
<ol class=breadcrumb>
<li><a href=home><i class=pe-7s-home></i> Home</a></li>
<li>Charts</li>
<li>Stok</li>
<li class=active>Stok Analiz</li>
</ol>
</div>
...
<div id="chart" style="	width		: 85%; 	height		:  85%; 	"></div>
                                        ...
                                        <table id="dataTableOne" class="table table-bordered table-striped table-hover">
                                            <thead>
                                                <tr>
                                                    <th><h4> Sıra </h4></th>
                                                    <th><h4>Marka </h4></th>
													<th><h4>Stok Tutarı </h4></th>
                                                    <th><h4>Satış Tutarı </h4></th>
												    <th><h4><?php print "SDG ".date('Y');?> </h4></th>
                                                    <th><h4><?php print "SDG ".date('Y',strtotime("-1 year"));?> </h4></th>													
                                                </tr>
                                            </thead>
                                         <tbody>                                                                                         
                                         </tbody>
                                        ...
                                        <table id="dataTableTwo" class="table table-bordered table-striped table-hover">
                                            <thead>
											            <th colspan="1"></th>
														<th colspan="3">Ürün Stok Tutarları</th>
														<th colspan="3">Stok Devir Günü</th>
                                                <tr>
                                                    <th><h4> Sıra </h4></th>
													...
													<th><h4><?php print date('Y');?> </h4></th>
                                                    <th><h4><?php print date('Y',strtotime("-1 year"));?> </h4></th>	
													<th><h4><?php print "Stok Miktarı";?> </h4></th>
                                                    <th><h4><?php print "Ortalama Satış Miktarı";?> </h4></th>														
                                                </tr>
                                            </thead>
                                         <tbody>                                                                                         
                                         </tbody>
    ...
    success:function(data)
    {
     ...
     {		
		 ...
		 tableOne.row.add( [
			...
			jsonDataTable[i].Stok_Alıs,
			jsonDataTable[i].Satıs,
			numberFormat(jsonDataTable[i].StokGunuThisYear,2),
			numberFormat(jsonDataTable[i].StokGunuLastYear,2) ]
         ).draw( false );
     }
	 }
    ...
    success:function(data)
    {
     ...
     {		
		 ...
		 tableTwo.row.add( [
			...
			numberFormat(jsonDataTable[i].Stok_Tutari,2),
			numberFormat(jsonDataTable[i].Stok_Tutari_Last_Year,2),
			numberFormat(jsonDataTable[i].SDG,2),
			numberFormat(jsonDataTable[i].SDG_Last_Year,2),
			numberFormat(jsonDataTable[i].Stok_Miktari),	
			numberFormat(jsonDataTable[i].ORT,2)			]
         ).draw( false );
     }
	 }
