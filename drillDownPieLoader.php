...
$namehelper = 12;
 ...
 $sql = "SELECT SUM(Stok_Alis_Tutari) AS Stok , UR.Ana_Kategori AS Ana_Kategori
...
while( $row = mysqli_fetch_assoc( $result )){
  ...
  $sqlTwo = "SELECT SUM(Stok_Alis_Tutari) AS Stok , UR.Kategori AS Kategori
					FROM pharmana_Hareket_db.general_Table HAR, pharmana_urun_db.general_Table UR
