...
<title>Stok - pharmanalitik</title>
...
<li  class="active"> <a href="stok"><img src="img/storage-iconONE.jpg" style="width:20px;height:20px;">  Stok</a>
</li>
...
<li>Charts</li>
<li>Stok</li>
<li class=active>Stok Ana Sayfa</li>
</ol>
</div>
...
<div class=panel-title>
<h5><?php
echo("Stok Drilldown Kategori Dağılım Payı");
?></h5>
</div>
</div>
<div class=panel-body>
...
tableOne = $('#dataTableOne').DataTable({
        ...
        { data: 'Stok_Alıs' },
	   { data: 'Satıs' },
	       { data: 'StokGunuThisYear' },
		       { data: 'StokGunuLastYear' }
    ]
});
 ...
 "type"    : "serial",
  ...
  "legend": {
	...
	"graphs": [
		...
		{
			"balloonText": "Gecen Sene Stok :[[value]]",
			"fillAlphas": 0.8,
			"id": "AmGraph-2",
			"lineAlpha": 0.2,
			"title": "Geçen Sene Stok",
			"type": "column",
			"valueField": "stokLastYear"
		},{
			"balloonText": "Stok:[[value]]",
			"fillAlphas": 0.8,
			"id": "AmGraph-1",
			"lineAlpha": 0.2,
			"title": "Stok",
